...
func addressesPaths(b *BackendLibra) []*framework.Path {
...
func (b *BackendLibra) pathAddressesRead(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
...
func (b *BackendLibra) pathAddressesList(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	_, err := b.configured(ctx, req)
	if err != nil {
		return nil, err
	}
...
func (b *BackendLibra) readAddress(ctx context.Context, req *logical.Request, address string) (*AccountNames, error) {
...
func (b *BackendLibra) pathAddressesVerify(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	_, err := b.configured(ctx, req)
	if err != nil {
		return nil, err
	}
...
func (b *BackendLibra) crossReference(ctx context.Context, req *logical.Request, name, address string) error {
...
func (b *BackendLibra) removeCrossReference(ctx context.Context, req *logical.Request, name, address string) error {
